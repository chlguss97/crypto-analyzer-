...
### 프로 레퍼런스 완전 일치 (12/12 EXACT)

PARTIAL 4건 해소 + 추가 기능:
- Hurst: 고정 스케일 → **동적 n/8,n/4,n/2,n**
- OU Z-Score: **0.93 감쇠** 추가
- Parkinson: **Realized Vol 50/50 블렌딩**
- CVD: **강도>0.3 모멘텀 오버라이드**
- TP: 고정 0.20% → **동적 k×vol** (SL과 대칭)
- 청산: **시그널 반전 즉시 청산** 추가
